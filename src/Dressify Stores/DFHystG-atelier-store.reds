...
protected cb func RegisterXDDFHystGStore(event: ref<VirtualShopRegistration>) -> Bool {
  event.AddStore(
    n"XDDFHystG",
    "Dressify - General Store",
    [
      /* ~~~~~~~~~~~~ 5 - Pack 1 ~~~~~~~~~~~~ */
      // ROGUE TANK LONG
      ...
      "Items.Rockerboy_01_Set_TShirt",

      // shortrougetank V3 (underboob)
