...
protected cb func RegisterXDDFHystCStore(event: ref<VirtualShopRegistration>) -> Bool {
  event.AddStore(
    n"XDDFHystC",
    "Dressify - Custom Store",
    [
      /* ~~~~~~~~~~~~ 25 - PANTS ONLY ~~~~~~~~~~~~ */
      // ALT PANT
    ...
    r"base/xerduke/icons/dressify_c.inkatlas",
    n"logo",
    [
      /* ~~~~~~~~~~~~ 25 - PANTS ONLY ~~~~~~~~~~~~ */
      // ALT PANT
